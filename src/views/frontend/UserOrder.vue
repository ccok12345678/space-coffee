  ...
  .row.justify-content-center
    ...
    Form.col-md-10.d-flex.flex-column(@submit="submitOrder"
      ...
      .row.justify-content-center
        ...
        .col-4.d-flex.flex-column(:class="{ 'mt-4': !errors['姓名'], 'mt-2': errors['姓名'] }")
        ...
        .col-4.d-flex.flex-column(:class="{'mt-4': !errors['tel'],'mt-2': errors['tel']}")
        ...
        .col-4.d-flex.flex-column(:class="{'mt-4': !errors['email'],'mt-2': errors['email']}")
        ...
        .col-8.offset-4(:class="{'mt-4': !errors['地址'],'mt-2': errors['地址']}")
